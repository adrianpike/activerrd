...
INCFLAGS = -I. -I. -I/System/Library/Frameworks/Ruby.framework/Versions/1.8/usr/lib/ruby/1.8/universal-darwin9.0 -I. -I/opt/local/include
CPPFLAGS =  
CXXFLAGS = $(CFLAGS) 
...
target_prefix = 
LOCAL_LIBS = 
LIBS = $(LIBRUBYARG_SHARED) -lfreetype -lpng -lz  -lpthread -ldl -lm  
SRCS = rrdtool_main.c
OBJS = rrdtool_main.o
TARGET = RRDtool
DLLIB = $(TARGET).bundle
...
install-rb-default: $(RUBYLIBDIR)/activerrd.rb
$(RUBYLIBDIR)/activerrd.rb: $(srcdir)/lib/activerrd.rb
	$(INSTALL_DATA) $(srcdir)/lib/activerrd.rb $(@D)
$(RUBYARCHDIR):
	$(MAKEDIRS) $@
$(RUBYLIBDIR):
	$(MAKEDIRS) $@
